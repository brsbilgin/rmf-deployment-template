...
ENV RMF_FLEET_ADAPTER=fleet_adapter_r3
ENV RMF_FLEET_ADAPTER_CONFIG_FILE=/opt/rmf/install/fleet_adapter_r3/share/fleet_adapter_r3/config.yaml
ENV RMF_FLEET_ADAPTER_NAV_GRAPH_FILE=/opt/rmf/src/lionsbot/fleet_adapter_r3/maps/02office/0.yaml
